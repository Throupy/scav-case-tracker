...
class User(db.Model, UserMixin):
    ...
    theme_mode = db.Column(db.String(10), nullable=False, default="dark", server_default="dark")
    accent_colour = db.Column(db.String(10), nullable=False, default="red", server_default="red")
    max_level_charisma = db.Column(db.Boolean, nullable=False, default=False, server_default="0")
